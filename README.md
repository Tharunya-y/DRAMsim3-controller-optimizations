...
The comparison plots for **bandwidth, latency, energy, and power** used in this project can be automatically generated using the provided Python script.

### Requirements

The plotting script requires Python with the following packages:
- `python3`
- `matplotlib`
- `numpy`
...
The script expects simulation output directories generated by DRAMsim3 to follow the naming convention:
out_<memory><workload><configuration>
examples :
-`out_hbm2_gups_BASE`
- `out_hbm2_gups_CA1`
- `out_hbm2_gups_PHASE2`
...
The comparison figures for bandwidth, latency, energy, and power are generated using:
``` bash
scripts/generate_plots.py
```
### Example Output Plot

The following figure shows an example comparison plot generated by the plotting script.
